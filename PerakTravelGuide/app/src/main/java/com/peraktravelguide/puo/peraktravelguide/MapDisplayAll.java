...
public class MapDisplayAll extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maps_all);
    ...
    private void parseLocationResult(JSONObject result) {
        ...
        String id, place_id, placeName = null, reference, icon = null, vicinity = null;
        ...
        try {
            ...
            if (result.getString(STATUS).equalsIgnoreCase(OK)) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    int height = 80;
                    int width = 80;
                    BitmapDrawable bitmapdraw = (BitmapDrawable) ContextCompat.getDrawable(MapDisplayAll.this, R.drawable.marker);
                ...
                Toast.makeText(MapDisplayAll.this, "Sorry, service unavailable", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onLocationChanged() {
        double latitude = 4.597479;
        double longitude = 101.090103;
        float minZoom = 10.0f;
